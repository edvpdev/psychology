...
export const ARTICLE_LIST_RESET = 'ARTICLE_RESET'
...
export const ARTICLE_DETAILS_RESET = 'ARTICLE_RESET'

export const ARTICLE_TITLES_REQUEST = 'ARTICLE_TITLES_REQUEST'
export const ARTICLE_TITLES_SUCCESS = 'ARTICLE_TITLES_SUCCESS'
export const ARTICLE_TITLES_FAIL = 'ARTICLE_TITLES_FAIL'
export const ARTICLE_TITLES_RESET = 'ARTICLE_RESET'
